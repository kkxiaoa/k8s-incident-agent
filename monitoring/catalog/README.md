...
| --- | --- | --- | --- | --- | --- |
| `ImagePullBackOff` | Task 1 | Pending | Pending Stage 2 integration | Pending | Pending |
...
`Watchdog` is monitoring-path health evidence. It does not create an Incident and is not a sixth fault family.
